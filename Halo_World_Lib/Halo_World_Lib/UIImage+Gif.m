...
{
    NSString *imagePath = [[HWUIHelper haloBundle] pathForResource:[NSString stringWithFormat:@"%@@%zdx", name, scale] ofType:@"gif"];
    if (!imagePath) {
        (scale + 1 > 3) ? (scale -= 1) : (scale += 1);
        imagePath = [[HWUIHelper haloBundle] pathForResource:[NSString stringWithFormat:@"%@@%zdx", name, scale] ofType:@"gif"];
    ...
    if (imagePath) {
        ...
        imagePath = [[HWUIHelper haloBundle] pathForResource:name ofType:@"gif"];
        if (imagePath) {
